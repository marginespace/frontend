    ...
    return (
      <div className="group/card h-fit  transition-all" style={style}>
        <AccordionItem
          ...
          className="block cursor-pointer rounded-[16px] border-2 border-light-purple bg-gradient-to-b from-[rgba(255,255,255,0.44)] via-[rgba(255,255,255,0.37)] bg-pos-100 p-[16px] pb-0 transition-all group-hover/card:bg-pos-0"
        >
