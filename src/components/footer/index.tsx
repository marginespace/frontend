...
export const Footer = () => {
  return (
    <footer className="container m-0 flex min-w-full flex-row flex-wrap items-end justify-between gap-[24px] bg-linear-white py-[16px] text-[14px] font-semibold text-white shadow-[0_-6px_10px_rgba(0,0,0,0.08)] backdrop-blur-[20px] lg:flex-row lg:items-center">
