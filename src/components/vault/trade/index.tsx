...
export const Trade = ({ vault, tokens, hiddenIds, admins }: TradeProps) => {
  ...
  return (
    <div className="col-span-6 rounded-[18px] p-0.5 lg:col-span-2">
      <div className="flex h-full flex-col gap-2 rounded-[16px] border-2 border-light-purple   bg-gradient-to-b from-[rgba(255,255,255,0.28)] via-[rgba(255,255,255,0.17)] p-[16px] sm:gap-4">
